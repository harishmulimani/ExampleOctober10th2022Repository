...
public class Assignment8CreateAndDeletedemotask {
	...
	private static void createTask() {
		try {
			oTask.getAddnewTask().click();
			Thread.sleep(3000);
			oTask.getCreatenewTask().click();
			Thread.sleep(3000);
			oTask.getTaskname1().sendKeys("DemoTask");
			Thread.sleep(3000);
			oTask.getCreateTaskSubmit().click();
			Thread.sleep(3000);
		}catch (Exception e )
		{
			e.printStackTrace();
	...
	private static void deleteTask() {
		try {
			oTask.getmodifyDemoTask().click();
			Thread.sleep(3000);
			oTask.getActionDemotask().click();
			Thread.sleep(3000);
			oTask.getDeleteDemoTask1().click();
			Thread.sleep(3000);
			oTask.getDeleteDemoTask1permanent().click();
			Thread.sleep(3000);
	}catch(Exception e)
		{
		e.printStackTrace();
